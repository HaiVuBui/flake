...
require('lazy').setup({
...

  {
    ...
    opts = {
      window = {
        width = 25, -- Fixed width in characters
      },
    },
  },
...
require('transparent').setup {
  ...
  extra_groups = {}, -- Optionally add extra groups for transparency
  exclude = { 'NormalFloat', 'Pmenu', 'FloatBorder' }, -- Exclude all floating windows and other specific windows
}
